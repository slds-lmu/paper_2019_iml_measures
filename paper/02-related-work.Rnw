...
% Other approaches
% =============================================================================
Further approaches measure interpretability as the usability of a model to support a human in a task, which is usually measured in a survey as response time, correctness of the response, and task difficulty \citep{zhou2018measuring,huysmans2011empirical,dhurandhar2017tip}.
