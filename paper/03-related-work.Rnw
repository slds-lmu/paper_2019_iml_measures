...
% ALE decompositions
% =============================================================================
Another approach is Accumulated Local Effects proposed by \cite{apley2016visualizing} (ALE) as a tool for visualizing feature effects (see e.g. Figure~\ref{fig:c-demo}), that also represents a decomposition.
