...
The measure can also be interpreted as the fidelity of the main effect models for approximating the black box model.
% =============================================================================
% PRE / PRL
% =============================================================================
We propose to measure the main effect approximation error (based on \citep{cooil1994reliability}) to measure the interaction strength IA:

\begin{eqnarray}\label{eqn:pre}
IAS = \frac{\mathbb{E}(L(\fh, \fale))}{\mathbb{E}(L(\fh, c))}
\end{eqnarray}
...
% R2 special case
% =============================================================================
When we use the $L2$-loss, the IAS is  $1 - R^2$.
