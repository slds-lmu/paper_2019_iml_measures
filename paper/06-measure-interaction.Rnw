...
% PRE / PRL
% =============================================================================
We define interaction strength as:
...
% R2 special case
% =============================================================================
When $L$ is the $L2$-loss, IAS equals 1 minus the R-squared measure:
$$IAS = \frac{\sum_{i=1}^n(\fh(\xi)-\faleme(\xi))^2}{\sum_{i=1}^n(\fh(x) - f_0)^2} = 1 - R^2$$
