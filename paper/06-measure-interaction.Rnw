...
% First order model
% =============================================================================
We propose to measure the level of additivity in the model by calculating the proportion of error for that is already covered by the main effects $\falej$, when we are predicting the outcome of the model.
