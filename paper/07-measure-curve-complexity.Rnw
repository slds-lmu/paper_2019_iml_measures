...
For example, the two ALE curves  \Sexpr{spark(app1$ale, c(-7, 7), width = 5)} and \Sexpr{spark(app2$ale, c(-7, 7), width = 5)} are identical except for the jump at 0.5 in the second curve.
