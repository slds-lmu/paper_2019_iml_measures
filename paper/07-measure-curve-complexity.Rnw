...
$$x^{(i)} \in I_k: z_{k-1} \leq f_{j,ALE}(x^{(i)}) \lt z_{k}$$
...
fc = FunComplexity$new(pred.ksvm, epsilon = 0.05, max_feat_cost = 10)
@
...
fc = FunComplexity$new(pred.ksvm, epsilon = 0.001, max_feat_cost = 10)
...
<<depends = "fun-complex">>=
fc.ksvm = FunComplexity$new(pred.ksvm, epsilon = 0.05, max_feat_cost = 10)
p1  = plot(fc.ksvm$approx_models$V1)
p2  = plot(fc.ksvm$approx_models$V2)
p3  = plot(fc.ksvm$approx_models$V3)
p4  = plot(fc.ksvm$approx_models$V4)


lrn = makeLearner("regr.rpart")
mod = train(lrn, tsk)
pred = iml::Predictor$new(mod, dat1)
fc.rpart = FunComplexity$new(pred, epsilon = 0.05, max_feat_cost = 10)
p5  = plot(fc.rpart$approx_models$V1)
p6  = plot(fc.rpart$approx_models$V2)
p7  = plot(fc.rpart$approx_models$V3)
p8  = plot(fc.rpart$approx_models$V4)
