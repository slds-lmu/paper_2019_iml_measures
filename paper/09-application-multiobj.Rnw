...
\section{Optimization for Performance and Interpretability}
\label{sec:multiobj}
% Datasets:
%
% Biodegradability
...
This dataset contains physicochemical properties like alcohol and residual sugar of \Sexpr{nrow(wine)} white wines.
...
TODO: Fix match between colname and model column
