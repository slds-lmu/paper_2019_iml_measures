...
They can be used for model selection, for model benchmarks and as objectives in automated machine learning frameworks.
...
This paper including code for experiments is online available at \url{https://github.com/compstat-lmu/paper_2018_autoiml}.
