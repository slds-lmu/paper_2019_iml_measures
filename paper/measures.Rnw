...
% ============================================================================
Based on Equation~\ref{eqn:decomp}, we decompose the prediction function into a constant (estimated as $f_0 = \frac{1}{n}\sum_{i=1}^n \hat{f}(\xi)$), plus the main effects (estimate with ALE), and a rest containing interactions (difference between full model and constant plus sum of main effects).
...
\end{eqnarray}
This arrangement of components emphasizes a decomposition of the prediction function into a main effect model and an interactions rest.
