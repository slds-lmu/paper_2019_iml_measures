...
Furthermore, we demonstrate the application of these measures in a multi-objective optimization approach which minimizes loss and complexity simultaneously.
