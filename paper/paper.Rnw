...
Furthermore, we demonstrate the application of such measures in a multi-objective optimization approach which minimizes loss and complexity simultaneously.
